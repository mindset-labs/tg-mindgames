...
export declare namespace RMap {
     ...
     * @typeparam V - the value type
     */
    interface NonEmpty<K, V> extends RMapBase.NonEmpty<K, V, RMap.Types>, Omit<RMap<K, V>, keyof RMapBase<any, any, any>> {
    }
    /**
     ...
     */
    interface Context<UK> extends RMapBase.Context<UK, RMap.Types> {
    }
    /**
     ...
     * @typeparam V - the value type
     */
    interface Builder<K, V> extends RMapBase.Builder<K, V, RMap.Types> {
    }
    /**
