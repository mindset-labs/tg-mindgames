...
import { type BiMapCreators } from '@rimbu/bimap/custom';
import type { RMap } from '@rimbu/collection-types/map';
import type { KeyValue } from '@rimbu/collection-types/map-custom';
import type { ArrayNonEmpty, OptLazy, RelatedTo, ToJSON, TraverseState, Update } from '@rimbu/common';
...
export declare namespace BiMap {
    /**
     ...
     * @typeparam V - the value type
     */
    interface NonEmpty<K, V> extends BiMap<K, V>, Streamable.NonEmpty<readonly [K, V]> {
        /**
     ...
     */
    interface Context<UK, UV, Tp extends BiMap.Types = BiMap.Types> extends BiMapFactory<UK, UV> {
        /**
...
export declare const BiMap: BiMapCreators;
