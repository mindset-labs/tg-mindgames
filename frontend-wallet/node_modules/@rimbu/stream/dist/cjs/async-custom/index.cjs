...
// src/async-custom/index.mts
var async_custom_exports = {};
__export(async_custom_exports, {
  AsyncAppendIterator: () => AsyncAppendIterator,
  AsyncCollectIterator: () => AsyncCollectIterator,
  AsyncConcatIterator: () => AsyncConcatIterator,
  AsyncDistinctPreviousIterator: () => AsyncDistinctPreviousIterator,
  AsyncDropIterator: () => AsyncDropIterator,
  AsyncDropWhileIterator: () => AsyncDropWhileIterator,
  AsyncFastIteratorBase: () => AsyncFastIteratorBase,
  AsyncFilterIterator: () => AsyncFilterIterator,
  AsyncFilterPureIterator: () => AsyncFilterPureIterator,
  AsyncFlatMapIterator: () => AsyncFlatMapIterator,
  AsyncFoldIterator: () => AsyncFoldIterator,
  AsyncFromStream: () => AsyncFromStream,
  AsyncIndexedIterator: () => AsyncIndexedIterator,
  AsyncIndicesOfIterator: () => AsyncIndicesOfIterator,
  AsyncIndicesWhereIterator: () => AsyncIndicesWhereIterator,
  AsyncIntersperseIterator: () => AsyncIntersperseIterator,
  AsyncLiveIterator: () => AsyncLiveIterator,
  AsyncMapIterator: () => AsyncMapIterator,
  AsyncMapPureIterator: () => AsyncMapPureIterator,
  AsyncOfIterator: () => AsyncOfIterator,
  AsyncOfStream: () => AsyncOfStream,
  AsyncPrependIterator: () => AsyncPrependIterator,
  AsyncReduceAllIterator: () => AsyncReduceAllIterator,
  AsyncReduceIterator: () => AsyncReduceIterator,
  AsyncRepeatIterator: () => AsyncRepeatIterator,
  AsyncSplitOnIterator: () => AsyncSplitOnIterator,
  AsyncSplitWhereIterator: () => AsyncSplitWhereIterator,
  AsyncStreamBase: () => AsyncStreamBase,
  AsyncStreamConstructorsImpl: () => AsyncStreamConstructorsImpl,
  AsyncTakeIterator: () => AsyncTakeIterator,
  AsyncTakeWhileIterator: () => AsyncTakeWhileIterator,
  AsyncUnfoldIterator: () => AsyncUnfoldIterator,
  AsyncWindowIterator: () => AsyncWindowIterator,
  AsyncZipAllWithItererator: () => AsyncZipAllWithItererator,
  AsyncZipWithIterator: () => AsyncZipWithIterator,
  FromAsyncIterator: () => FromAsyncIterator,
  FromIterator: () => FromIterator,
  FromPromise: () => FromPromise,
  FromResource: () => FromResource,
  FromResourceIterator: () => FromResourceIterator,
  FromSource: () => FromSource,
  asyncStreamSourceToIterator: () => asyncStreamSourceToIterator,
  closeIters: () => closeIters,
  emptyAsyncFastIterator: () => emptyAsyncFastIterator,
  emptyAsyncStream: () => emptyAsyncStream,
  fixedDoneAsyncIteratorResult: () => fixedDoneAsyncIteratorResult,
  fromAsyncStreamSource: () => fromAsyncStreamSource,
  isAsyncFastIterator: () => isAsyncFastIterator,
  isAsyncStream: () => isAsyncStream,
  isEmptyAsyncStreamSourceInstance: () => isEmptyAsyncStreamSourceInstance
});
module.exports = __toCommonJS(async_custom_exports);
...
((AsyncTransformer2) => {
  AsyncTransformer2.window = (windowSize, skipAmount = windowSize, collector = import_common5.AsyncReducer.toArray()) => {
    return import_common5.AsyncReducer.create(
      () => /* @__PURE__ */ new Set(),
      async (state, elem, index) => {
        ...
        if (index % skipAmount === 0) {
          const newState = {
            result: await import_common5.AsyncOptLazy.toMaybePromise(collector.init),
            size: 1,
            halted: false,
            halt() {
              this.halted = true;
          ...
          newState.result = collector.next(
            await import_common5.AsyncOptLazy.toMaybePromise(collector.init),
            elem,
            0,
            newState.halt
          );
  ...
  function distinctPrevious(eq = import_common5.Eq.objectIs) {
    return import_common5.AsyncReducer.create(
      () => [],
      (current, elem) => {
        current.push(elem);
...
var AsyncStreamBase = class {
  ...
  async equals(other, eq = import_common6.Eq.objectIs) {
  ...
  async forEach(f, state = (0, import_common6.TraverseState)()) {
    if (state.halted)
      return;
    const done = Symbol("Done");
    let value;
  ...
  async first(otherwise) {
    ...
    if (done === value) {
      return import_common6.AsyncOptLazy.toPromise(otherwise);
    }
  ...
  async countElement(value, eq = import_common6.Eq.objectIs) {
    let result = 0;
    const done = Symbol("Done");
    const iterator = this[Symbol.asyncIterator]();
    let current;
  ...
  async countNotElement(value, eq = import_common6.Eq.objectIs) {
    let result = 0;
    const done = Symbol("Done");
    const iterator = this[Symbol.asyncIterator]();
    let current;
  ...
  indicesOf(searchValue, eq = import_common6.Eq.objectIs) {
  ...
  async indexOf(searchValue, occurrance = 1, eq = import_common6.Eq.objectIs) {
    if (occurrance <= 0)
      return void 0;
    const done = Symbol("Done");
    let value;
  ...
  async containsSlice(source, eq = import_common6.Eq.objectIs) {
    const iterator = this[Symbol.asyncIterator]();
  ...
  min(otherwise) {
    return this.minBy(import_common6.Comp.defaultComp().compare, otherwise);
  }
  ...
  max(otherwise) {
    return this.maxBy(import_common6.Comp.defaultComp().compare, otherwise);
  }
  ...
  splitOn(sepElem, eq = import_common6.Eq.objectIs) {
    return new AsyncSplitOnStream(this, sepElem, eq);
  }
  distinctPrevious(eq = import_common6.Eq.objectIs) {
    return new AsyncDistinctPreviousStream(this, eq);
  }
  window(windowSize, skipAmount = windowSize, collector = import_common6.AsyncReducer.toArray()) {
    return new AsyncWindowStream(this, windowSize, skipAmount, collector);
  }
  async fold(init, next) {
    let current = await import_common6.AsyncOptLazy.toMaybePromise(init);
    const state = (0, import_common6.TraverseState)();
    const done = Symbol("done");
    const iterator = this[Symbol.asyncIterator]();
    let value;
    try {
  ...
  async reduce(reducer) {
    const traverseState = (0, import_common6.TraverseState)();
    const next = reducer.next;
    let state = await import_common6.AsyncOptLazy.toMaybePromise(reducer.init);
    const done = Symbol("Done");
    let value;
    const iter = this[Symbol.asyncIterator]();
    try {
  ...
  async reduceAll(...reducers) {
    let state = await Promise.all(
      reducers.map((d) => import_common6.AsyncOptLazy.toMaybePromise(d.init))
    );
...
var AsyncPrependStream = class extends AsyncStreamBase {
  ...
  async first() {
    return import_common6.AsyncOptLazy.toPromise(this.item);
  }
  async last() {
    return this.source.last(this.item);
  }
...
var AsyncEmptyStream = class extends AsyncStreamBase {
  ...
  transform(transformer) {
    return AsyncStreamConstructorsImpl.from(
      async () => await transformer.stateToResult(
        await import_common6.AsyncOptLazy.toMaybePromise(transformer.init)
      )
    );
  }
  filter() {
  ...
  fold(init) {
    return import_common6.AsyncOptLazy.toPromise(init);
  }
  foldStream() {
    return this;
  }
  async reduce(reducer) {
    return reducer.stateToResult(await import_common6.AsyncOptLazy.toPromise(reducer.init));
  }
  reduceStream() {
    return this;
  }
  reduceAll(...reducers) {
    return Promise.all(
      reducers.map(
        async (p) => p.stateToResult(await import_common6.AsyncOptLazy.toMaybePromise(p.init))
      )
    );
  }
  reduceAllStream() {
