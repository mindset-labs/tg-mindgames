...
var stream_custom_exports = {};
__export(stream_custom_exports, {
  AlwaysStream: () => AlwaysStream,
  ArrayStream: () => ArrayStream,
  DistinctPreviousStream: () => DistinctPreviousStream,
  FilterApplyStream: () => FilterApplyStream,
  FromIterable: () => FromIterable,
  FromStream: () => FromStream,
  MapApplyStream: () => MapApplyStream,
  RangeStream: () => RangeStream,
  StreamBase: () => StreamBase,
  StreamConstructorsImpl: () => StreamConstructorsImpl,
  WindowStream: () => WindowStream,
  emptyStream: () => emptyStream,
  fromStreamSource: () => fromStreamSource,
  isEmptyStreamSourceInstance: () => isEmptyStreamSourceInstance,
  isStream: () => isStream
});
module.exports = __toCommonJS(stream_custom_exports);
