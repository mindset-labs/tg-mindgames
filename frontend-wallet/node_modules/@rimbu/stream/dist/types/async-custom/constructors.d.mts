...
export interface AsyncStreamConstructors {
    ...
    fromResource<T, R>(open: () => MaybePromise<R>, createSource: (resource: R) => AsyncStreamSource.NonEmpty<T>, close: (resource: R) => MaybePromise<void>): AsyncStream.NonEmpty<T>;
    fromResource<T, R>(open: () => MaybePromise<R>, createSource: (resource: R) => MaybePromise<AsyncStreamSource<T>>, close: (resource: R) => MaybePromise<void>): AsyncStream<T>;
    /**
    ...
    unzip<T extends readonly unknown[] & {
        length: L;
    }, L extends number>(source: AsyncStream.NonEmpty<T>, length: L): {
        [K in keyof T]: AsyncStream.NonEmpty<T[K]>;
    };
    unzip<T extends readonly unknown[] & {
        length: L;
    }, L extends number>(source: AsyncStream<T>, length: L): {
