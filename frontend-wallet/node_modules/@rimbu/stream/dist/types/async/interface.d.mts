import type { AsyncFastIterable, AsyncStreamSource, AsyncStreamable, AsyncTransformer } from '@rimbu/stream';
 ...
 * ```
 */
export interface AsyncStream<T> extends AsyncFastIterable<T>, AsyncStreamable<T> {
    /**
...
export declare namespace AsyncStream {
    /**
     ...
     * ```
     */
    interface NonEmpty<T> extends AsyncStream<T> {
        /**
...
export declare const AsyncStream: AsyncStreamConstructors;
