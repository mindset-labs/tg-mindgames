...
import type { Block, BlockBuilder, CacheMap, ListContext, NonLeafBuilder } from '@rimbu/list/custom';
export interface NonLeaf<T, C extends Block<any, C> = any> {
    ...
    mapPure<T2>(mapFun: (value: T) => T2, reversed?: boolean, cacheMap?: CacheMap): NonLeaf<T2>;
    map<T2>(mapFun: (value: T, index: number) => T2, reversed?: boolean, indexOffset?: number): NonLeaf<T2>;
