...
export declare namespace HashSet {
     ...
     * ```
     */
    interface NonEmpty<T> extends RSetBase.NonEmpty<T, HashSet.Types>, Omit<HashSet<T>, keyof RSetBase.NonEmpty<any, any>>, Streamable.NonEmpty<T> {
    }
    /**
     ...
     */
    interface Context<UT> extends RSetBase.Context<UT, HashSet.Types> {
     ...
     * @typeparam T - the value type
     */
    interface Builder<T> extends RSetBase.Builder<T, HashSet.Types> {
    }
    /**
...
export declare const HashSet: HashSetCreators;
