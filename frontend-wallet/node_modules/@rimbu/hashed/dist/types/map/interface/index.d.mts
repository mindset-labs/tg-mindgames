...
export declare namespace HashMap {
     ...
     * ```
     */
    interface NonEmpty<K, V> extends RMapBase.NonEmpty<K, V, HashMap.Types>, Omit<HashMap<K, V>, keyof RMapBase.NonEmpty<any, any, any>>, Streamable.NonEmpty<readonly [K, V]> {
     ...
     */
    interface Context<UK> extends RMapBase.Context<UK, HashMap.Types> {
     ...
     * @typeparam V - the value type
     */
    interface Builder<K, V> extends RMapBase.Builder<K, V, HashMap.Types> {
    }
    /**
...
export declare const HashMap: HashMapCreators;
