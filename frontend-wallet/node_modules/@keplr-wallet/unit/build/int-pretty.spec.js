...
describe("Test IntPretty", () => {
    it("Test creation of IntPretty", () => {
        ...
        expect(new int_pretty_1.IntPretty(new decimal_1.Dec("5")).toString()).toBe("5");
        expect(new int_pretty_1.IntPretty(new decimal_1.Dec("5.0")).toString()).toBe("5");
        ...
        expect(new int_pretty_1.IntPretty(1.1).toDec().equals(new decimal_1.Dec("1.1"))).toBe(true);
        expect(new int_pretty_1.IntPretty(1.1).maxDecimals(2).toString()).toBe("1.10");
        expect(new int_pretty_1.IntPretty(1.1234).maxDecimals(2).toString()).toBe("1.12");
        expect(new int_pretty_1.IntPretty(0.1234).maxDecimals(2).toString()).toBe("0.12");
        expect(new int_pretty_1.IntPretty(0.003).maxDecimals(2).toString()).toBe("0.00");
        expect(new int_pretty_1.IntPretty(0.00003456).toString()).toBe("0.00003456");
